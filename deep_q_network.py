...
class FRLDQN(object):
    ...
    def build_dqn(self):
        ...
        self.s_b = tf.compat.v1.placeholder(tf.float32, [None, self.state_beta_dim, self.state_beta_dim, self.hist_len], 's_b')
        ...
        self.alpha_q_input = tf.compat.v1.placeholder(tf.float32, [None, self.num_actions], 'alpha_q_input')
        self.beta_q_input = tf.compat.v1.placeholder(tf.float32, [None, self.num_actions], 'beta_q_input')
